            ...
            >
                ...
                >
                    ...
                    {message.text && (
                        ...
                        <div
                            className={`p-3 rounded-xl text-sm flex items-start gap-3 border ${message.type === "success"
                        ...
                        >
                            ...
                            <div
                                className={`w-1.5 h-1.5 rounded-full mt-1.5 shrink-0 ${message.type === "success"
                                        ? "bg-emerald-500"
                                        : "bg-rose-500"
                                    }`}
                            />
