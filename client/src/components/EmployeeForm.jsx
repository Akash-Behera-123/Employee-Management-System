    ...
    {/* Personal information */} 
      <div className="card p-5 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
            ...
            <div className="sm:col-span-2">
                ...
                <textarea name="bio" required  defaultValue={initialData?.bio} rows={3} className="resize-name" placeholder="Brief description..."></textarea>
            </div>
        </div>
      </div>
     ...
     {/* Employment details */}
       <div className="card p-5 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-smtext-slate-700">
               <div>
            ...
            {isEditMode &&(
                ...
                <select type="number" name="employmentStatus" defaultValue={initialData?.employmentStatus}>
